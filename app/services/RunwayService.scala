  ...
  def insert(runway: Runway) = {
    db.withConnection { implicit connection =>
      SQL(
        ...
        'airIdent -> runway.airportIdent.removeQuotes,
        'length -> runway.lengthFt,
        'width -> runway.widthFt,
        'surface -> runway.surface.removeQuotes,
        'lighted -> runway.lighted,
        'closed -> runway.closed,
        'leIdent -> runway.leIdent.getOrElse("").removeQuotes,
        ...
        'heIdent -> runway.heIdent.getOrElse("").removeQuotes,
